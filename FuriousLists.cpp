...
// Description : Concerning the particulars of linked lists and their furious potential
//============================================================================
...
#include "Timer.h"
#include "CSnake.h"				// dep on MFuncs
...
CMembrane membrane(100, 100, 0, 100);
CPropagator actin(20000, 100, 0, 400), p1(5000, 100, 0, 300), p2(2000, 100, 0, 500), p3(40000, 100, 0, 600), p4(10000, 100, 0, 700);
/*****CLASSES***********************************************
*************-*-*-*-*CLASSES*****-*-*-*-********************
***********************************************************/
class GUIdrawer
...
void drawGround(void)													// Costs approx 50 fps
{
	...
	DrawGrid(GAME_MAP_SIZE_Z, GAME_MAP_SIZE_X, 10);
}
...
void callbackThirtySec(void)											// Called every 30s
{

}
void callbackOneSec(void)												// Called every second
{
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Furious Lists!");	 	         //Name of window.
